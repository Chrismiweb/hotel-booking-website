...
function Hero() {
  return (
    ...
    <div className="relative w-full py-[250px] h-[450px] flex justify-around items-center overflow-hidden">
      ...
      <div className='absolute w-[100%] h-[450px] flex justify-around items-center'>
