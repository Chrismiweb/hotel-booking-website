...
function Hero() {
  return (
    ...
    <div className="relative w-full py-[250px] md:h-[450px] flex justify-around items-center overflow-hidden">
      ...
      <div className='absolute w-[100%] md:h-[450px] flex flex-col md:flex-row justify-around items-center'>
